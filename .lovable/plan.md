...
- Impressão: folha A4, texto a preto sobre branco, linhas de grelha visíveis, sem cortes de coluna, cabeçalho repetido e legenda dos códigos no fim.
...
- Mover "Propriedade e Gestão da Plataforma" para o fim, dentro do rodapé, com o nome "Direcção Geral da Juventude" e o email jimua.caoa@gmail.com.
...
## 6. Auditoria
- Nova página "Auditoria" visível apenas a Secretário Geral e Distrital, listando as alterações já registadas nas fichas de jovens (jovem, campo, valor anterior, valor novo, autor, data), com pesquisa e filtro por período, respeitando a jurisdição de cada perfil.
